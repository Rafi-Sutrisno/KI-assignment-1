/*
  ...
  - Added the required column `health_data` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "health_data" TEXT NOT NULL,
